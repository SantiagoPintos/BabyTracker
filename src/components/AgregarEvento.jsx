...
const AgregarEvento = () => {
  ...
  const agregarEvento = () => {
    ...
    //Elimina "T" de la fecha para que coincida con el formato que viene dese la API
    //esto evita problemas al comparar fechas, el formato "2024-08-07T19:41" se convierte en "2024-08-07 19:41"
